...
Nova.booting(function (Vue, router) {
    Vue.component('index-nova-select2', __webpack_require__(3));
    Vue.component('detail-nova-select2', __webpack_require__(6));
    Vue.component('form-nova-select2', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c(
    "ul",
    _vm._l(_vm.field.value, function(value) {
      return _c("li", [_c("span", [_vm._v('"{{value.title.ru}"}')])])
    })
  )
}
var staticRenderFns = []
  ...
  return _c(
    ...
    [
      _c(
        ...
        { slot: "value" },
        _vm._l(_vm.field.value, function(value) {
          return _c("span", { staticClass: "selected" }, [
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        fill: function fill(formData) {
            var value = _.map(this.value, 'value');
      ...
      _c(
        ...
        [
          ...
          _vm.hasError
            ...
            : _vm._e(),
          _vm._v(" "),
          _c("label", [_vm._v(_vm._s(_vm.field.option))])
        ],
        1
      )
    ],
